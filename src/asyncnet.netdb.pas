...
uses SysUtils, Classes, Generics.Collections, Sockets, stax;
...
function IsIPv4Mapped(const IPv6Addr: String): Boolean;
begin
  Result := IN6_IS_ADDR_V4MAPPED(StrToHostAddr6(IPv6Addr));
end;
